...
protocols = [
    ...
    "https-head","https-head-auth","https-proxyimport sys
import subprocess
import signal
import os
import ipaddress
...
class CyberHydra(QWidget):
    ...
    def initMusic(self):
        try:
            ...
            self.media_player.setVolume(self.settings.value("volume", 30, int))
...
if __name__ == "__main__":
    ...
    win.show()
    sys.exit(app.exec())
","https-proxy-urlenum","https-put","icq","imap","imaps","informix",
